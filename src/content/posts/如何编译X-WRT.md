...
description: '从环境准备到编译完成的完整指南，帮助用户编译自定义的X-WRT固件'
image: '../assets/images/x-wrt-tx.png'
tags: [x-wrt, 编译, openwrt, 教程]
category: '教程'
draft: false
lang: ''
---
...
![](https://cdn-esa-cn-1.3284123.xyz/gh/x-wrt/x-wrt.github.io@master/docs/build/build-target.png)
...
定位到各个子菜单，选择对应的软件包
![](https://cdn-esa-cn-1.3284123.xyz/gh/x-wrt/x-wrt.github.io@master/docs/build//build-m.png)
